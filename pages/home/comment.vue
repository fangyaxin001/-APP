<template>
	<view class="">
		<view class="comment" v-if="itemStatus">
		...
		<view class="text-center padding-xl text-bold" v-else>
			{{itemStatusMsg}}~
		</view>
	</view>
</template>
			...
			getShowData(id) {
				...
				this.$api.post(global.apiUrls.commentDetails, {
					...
					if (res.code == 1) {
						...
						_this.itemStatus = false;
						_this.itemStatusMsg = res.msg;
					}
				})
			},
