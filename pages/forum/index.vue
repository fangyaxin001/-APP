			...
			<scroll-view class="scroll-view_H"  scroll-x="true" :show-scrollbar="true" >
				<view class="tab" :class="forum_num>0?'':'padding-top'">
					<view class="text-center item" v-for="(item,index) in classList" :key="index">
						...
						<view class="" @click="handleJump" :data-url="'/pages/forum/classify?id='+item.id">
							<u-image border-radius="50%" :src="item.cat_img" mode="aspectFill" width="88rpx" height="88rpx"></u-image>
