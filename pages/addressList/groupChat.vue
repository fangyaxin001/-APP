	...
	<view class="search">
		...
		<view class="content">
			...
			<view class="" v-if="listData.length>0">
				<view class="cu-form-group border-0" @click.stop="handleJump" :data-url="`/pages/chat/chat?id=${item.id}&type=2&title=${item.group_title}&group_id=${item.hanxin_group_id}`"
