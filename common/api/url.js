export default {
	...
	disposeHuanxin:'/v1/6041f0c8e0733', //处理环信数据
	

	// 登录个人中心 
	
	loginFlag: '/v1/60cb1a6a11643', //上架时判断登录状态
	myXieyi: '/v1/60a4d95a3c06a', //用户协议&&隐私协议
	aliSend: '/v1/5c78dca45ebc1', //发送验证码
	postloginByAccount: '/v1/5c78dbfd977cf', //密码登录 1
	loginByQuick: '/v1/6033183f3ef28', //第三方登录qq
	loginWxByQuick: '/v1/5d7757d28d076', //第三方登录weixin
